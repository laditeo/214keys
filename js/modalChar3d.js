...
import {
  acquireGlyphMesh,
  getGlyphMaterialMode,
  GLYPH_CANVAS_PX,
  releaseGlyphMeshInstance,
  renderSceneWithOutline,
  syncDepthMaterialsForCamera,
...
const _modalDrawSize = new THREE.Vector2();
...
function renderFrame() {
  ...
  renderer.getDrawingBufferSize(_modalDrawSize);
  syncDepthMaterialsForCamera(camera, scene, _modalDrawSize);
  if (getGlyphMaterialMode() === "depth") {
