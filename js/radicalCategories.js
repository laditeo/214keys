/**
 * Семантические категории ключей (цветовая таксономия как на spatial-canvas).
 */
...
const CHAR_SETS = [
  ["stroke", "一丨丶丿乙亅"],
  ["number", "二八十"],
  ["enclosure", "冂匚匸勹囗冖宀广厂尸疒襾門阜鬲冫凵匸"],
  ["human", "人儿入女子弟寸尸心手父面目身首齿鼻髟肉自頁止牙舌足骨"],
  ["nature", "日月水火山石土木禾竹雨風風气氣气黍麻黃黄黑靑青夕山巛川"],
  ["animal", "犬牛馬马鳥鸟魚鱼虫羊虎龍龙龜龟鹿鼠鬼隹豕豸"],
  ["object", "刀車车舟弓斤戈鼎鼓玉瓦皿缶网网巾戈矛矢車车鬥斗酉食首香"],
];
